...
class User(Base):
    ...
    #plants = relationship("Plant", backref="user")
    #pots = relationship("Pot", backref="user")
...
class Database_repo:
    ...
    def get_user_by_username(self, username):
        try:
            ...
            print(f"Dok smo tražili korisnika {username} dogodila se greška: {e}")
            return None
